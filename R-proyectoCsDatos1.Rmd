...
# Grafico cantidad de escuelas de gestión dependencia funcional

## Hago un histograma por dependencia funcional
...
ggplot(escuelas, aes(y = factor(depfun)))+
  ...
  labs(title = "Establecimientos por dependencia funcional", x = "depfun", y = "Frecuencia")
